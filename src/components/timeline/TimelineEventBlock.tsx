...
export function TimelineEventBlock({ event, pxPerSecond, color, isSelected, onPointerDown, onDelete }: TimelineEventBlockProps) {
  ...
  return (
    <div
      ...
      title={`${event.action} @ ${event.time.toFixed(3)}s`}
    >
      {isSelected && (
        <button
          type="button"
